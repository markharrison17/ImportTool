...
#RUN mkdir -p /usr/src/ImportTool/import_tool
#COPY import.py /usr/src/ImportTool/import.py
#COPY import_tool /usr/src/ImportTool/import_tool
#USER service
#CMD ["python3", "-u", "/usr/src/ImportTool/import.py"]
